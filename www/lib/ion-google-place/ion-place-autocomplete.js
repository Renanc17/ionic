            ...
            return {
                ...
                link: function(scope, element, attrs, ngModel) {
                    ...
                    scope.selectLocation = function(location) {
                        $rootScope.address = location.description;
                    ...
                    scope.$watch('searchQuery', function(query) {
                        ...
                        }, 50); // we're throttling the input by 350ms to be nice to google's API
                    });
                    ...
                    var onClick = function(e) {
                        ...
                        console.log(searchInputElement[0]);
...
var template = '<div class="item ion-place-tools-autocomplete">' +
                    '<input type="text" autocomplete="off" ng-model="searchQuery" style="width: 100% !important;">' +
                    '<div class="ion-place-tools-autocomplete-dropdown" ng-if="dropDownActive">' +
                        '<ion-list style="color: #000000 !important;">' +
                            '<ion-item ng-repeat="location in locations" ng-click="selectLocation(location)" style="padding-left: 0px !important;">' +
